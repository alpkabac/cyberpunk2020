...
/** Persists voice STT + AI-GM language into \`sessions.settings\` (Realtime sync for all clients). */
export async function persistSessionLanguageSettings(
  client: SupabaseClient,
  sessionId: string,
  patch: Partial<Pick<SessionSettings, 'sttLanguage' | 'aiLanguage'>>,
