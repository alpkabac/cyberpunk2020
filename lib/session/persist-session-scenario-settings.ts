...
/** Persists active scenario module id into `sessions.settings` (Realtime sync for all clients). */
export async function persistSessionScenarioSettings(
  client: SupabaseClient,
  sessionId: string,
  patch: Partial<Pick<SessionSettings, 'activeScenarioId'>>,
